...
export const MateriasPage = () => {
   ...
   const calculateRemainingTerms = () => {
      ...
      const subjectsPerSemester =
         periods.size > 0 ? passedSubjects.length / periods.size : 5;
   ...
   return (
      <Box position="relative" minH="100vh" display="flex" flexDirection="column">
         ...
         <Box p={8} flex="1" display="flex" flexDirection="column">
            <VStack align="start" mb={4}></VStack>
            ...
            {/* Bottom buttons */}
            <HStack position="fixed" right="20px" bottom="20px" gap={4}>
               <Button
